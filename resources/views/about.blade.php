            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-pull-8 animate-box">
                    <div class="mt">
                        ...
                        <p>Lekki-Ville Academy is an education solution company that provides the following services</p>
                        <ul class="list-nav">
                            <li><i class="icon-check2"></i>Private Home Tution: Nursey, Primary School, WAEC, JAMB.</li>
                            <li><i class="icon-check2"></i>Private Home/Office Tution for the following foreign examination: SAT, A'Level, IGCSE, GMAT, GRE, TOEFL, IELT</li>
                            <li><i class="icon-check2"></i>Education Consulting Service e.g. Staff Training.</li>
                        </ul>
                        <p></p>
                    </div>
                </div>
                ...
                <div class="col-md-4 animate-box">
                    <div class="mt">
                        <div>
                            ...
                            <p>Lekki-Ville Academy has highly qualified and experience tutors that have undergone security clearance. Lekki-Ville Academy is run by a team of qualified Educationists, 
                                who have a decade of experience in teaching.</p>
                        </div>
                        <div>
